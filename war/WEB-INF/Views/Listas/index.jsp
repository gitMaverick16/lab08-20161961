...
<link rel="stylesheet" type="text/css" href="../css/estilo.css" />
	...
	<br>
	<%
		List<Listas> listas = (List<Listas>) request.getAttribute("listas");
	%>
	<center>
		<a href="/listas/add">Agregar Lista</a>
	</center>
	...
	<div class="container" style="background-color: #FFFFFF;">
		...
		<ul class="list-group" id="myList">
			...
			%>
			<%
				Listas u = (Listas) listas.get(i);
			%>
			<li class="list-group-item"><%=u.getDia()%> <a
				href="/listas/delete?id=<%=u.getId()%>"
				class="btn btn-outline-danger btn-sm RbtnMargin float-right">Delete
					</button>
			</a> <a href="/listas/view?id=<%=u.getId()%>"
				class="btn btn-outline-secondary btn-sm RbtnMargin float-right">View
					</button>
			</a> <a href="/listas/update?id=<%=u.getId()%>"
